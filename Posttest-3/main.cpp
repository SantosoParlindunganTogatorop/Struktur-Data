...
void tambahJadwal(Node *&head, string code, int &squence){
    ...
    if(head == nullptr){
        ...
        temp->next = newNode;
        newNode->prev = temp; // sambungkan ke node sebelumnya
    }
...
void hapusAwal(Node *&head){
    if (head==nullptr){
        ...
        Node* temp = head;
        head = head->next;
        if(head != nullptr) head->prev = nullptr; // putuskan hubungan belakang
...
void showDetail(Node *&head){
    if(head == nullptr){
        cout<<"Data Kosong"<<endl;
        cout<<"Tidak ada data untuk ditampilkan"<<endl;
    }else{
        string kode;
        cout<<"Masukkan kode penerbangan yang dicari: ";
        cin>>kode;
        cin.ignore(numeric_limits<streamsize>::max(), '\n');
        ...
        if(temp == nullptr){
            cout<<"Kode penerbangan "<<kode<<" tidak ada"<<endl;
        }else{
...
void terbalik(Node *&head){
        ...
        cout<<"Daftar Jadwal Penerbangan Traversal dari belakang"<<endl;
        cout<<string("=",40)<<endl;
        cout<<left<<
        setw(4)<<"No"<<
        setw(9)<<"Kode"<<
...
int main(){
    ...
    do{
        ...
        cout<<"| 6. Tampilkan Detail Berdasarkan Kode|"<<endl;
        cout<<"| 7. Tampilkan Dari belakang          |"<<endl;
        cout<<"| 0. Keluar                           |"<<endl;
        cout<<" "<<string(36,'=')<<endl;
        cout<<"Pilihan Anda : ";
        cin>>pilih;
        ...
        case 6: showDetail(head); break;
        case 7: terbalik(head); break;
